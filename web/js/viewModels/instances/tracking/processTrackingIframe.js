 ...
 */
define(['ojs/ojcore', 'knockout', 'ojs/ojknockout', 'obpmConfig'],
function(oj, ko)
{
  function ProcessTrackingViewModel(params)
  {
    var self = this;
      ...
      self.processAuditDiagramByAjax = function (processId) {
        ...
        self.processAuditDiagram(obpmConfig.serverurl + "BPMProcessMap/vPilot/BPMProcessMap.jsp?bpmnInstanceID="+processId);
      }
  }

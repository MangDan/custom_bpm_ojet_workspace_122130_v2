 ...
 */
define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojmasonrylayout', 'ojs/ojavatar'],
  function (oj, ko, $) {
    function TaskDashboardViewModel() {
      var self = this;
      ...
      self.avatarSize = ko.observable(self.large() ? "xl" : "md");  //'xxs', 'xs','sm','md','lg','xl','xxl'
    }
